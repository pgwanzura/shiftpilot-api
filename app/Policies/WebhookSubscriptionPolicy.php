...
class WebhookSubscriptionPolicy
{
     ...
     */
    public function restore(User $user, WebhookSubscription $webhookSubscription): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, WebhookSubscription $webhookSubscription): bool
    {
        return false;
    }
}
